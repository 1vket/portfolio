...
function loadSections() {
  fetch('/get_sections/langdict.txt')
        ...
        if(section.length > 0){
          ...
          subSections.forEach(subSection => {
            ...
            if (subSection.length > 0) {
              ...
              let imgElement = null;
              let refElement = null;
              const subSectionName = subSection.substring(0, subSection.indexOf('\n')).trim();
              let content = subSection.substring(subSection.indexOf('\n'));
              
              if(content.indexOf("@@") != -1){
                let img = content.substring(content.indexOf('@@')).trim();
              ...
              if(content.indexOf("$$") != -1){
                let ref = content.substring(content.indexOf('$$')).trim();
